...
extension HysteriaManager {
    ...
    private func infoCenterWithTrack(track: PlayerTrack?) {
        ...
        if var dictionary = MPNowPlayingInfoCenter.defaultCenter().nowPlayingInfo {
            ...
            dictionary[MPMediaItemPropertyPlaybackDuration] = NSTimeInterval(hysteriaPlayer.getPlayingItemDurationTime())
            dictionary[MPNowPlayingInfoPropertyElapsedPlaybackTime] =  NSTimeInterval(hysteriaPlayer.getPlayingItemCurrentTime())
